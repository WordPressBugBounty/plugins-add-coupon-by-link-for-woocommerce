...
/**
 * Total Product Quantity in Cart Condition
 *
...
/**
 * Class for total product quantity condition
 */
class Cart_Quantity extends Base_Condition {
    ...
    public function get_name() {
        return __('Cart quantity', 'add-coupon-by-link-woocommerce');
    }
