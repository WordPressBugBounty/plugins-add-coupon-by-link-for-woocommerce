...
class pisol_acblw_other_plugins{
    ...
    private $this_tab = 'pisol_acblw_other_plugins';
    ...
    function tab(){
        ...
        <a class="nav-link text-light  <?php echo ($this->active_tab == $this->this_tab ? 'active' : ''); ?>" href="<?php echo esc_url( admin_url( 'admin.php?page='.sanitize_text_field($_GET['page']).'&tab='.$this->this_tab ) ); ?>">
            <img class="pi-icon" src="<?php echo esc_url( plugin_dir_url( __FILE__ ) ); ?>img/plugin.svg"> <?php echo esc_html( $this->tab_name ); ?> 
        </a>
        </li>
        <li class="nav-item mb-0">
        <a class="nav-link text-light " href="https://wordpress.org/support/plugin/add-coupon-by-link-for-woocommerce/reviews/#bbp_topic_content" target="_blank">
...
new pisol_acblw_other_plugins($this->plugin_name);
